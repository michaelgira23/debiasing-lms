...
class BiasEvaluator(object):
    def __init__(self, trained_intra_model, trained_inter_model,pretrained_class="gpt2", no_cuda=False, batch_size=51, input_file="data/bias.json",
        ...
        self.trained_intra_model = trained_intra_model
        self.trained_inter_model = trained_inter_model
    ...
    def evaluate_intrasentence(self):
        ...
        model = self.trained_intra_model
        model.eval()
    ...
    def evaluate_nsp_intersentence(self,args):
        print()
        print(
        ...
        model = self.trained_inter_model.to(self.device)
